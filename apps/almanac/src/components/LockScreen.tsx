// LockScreen.tsx
// The vault is closed. Not a plan, not a date, not a word of where you'll
// be is in memory until the passphrase (or a biometric shortcut to the same
  ...
  return (
    <div className="gate">
      <div className="gate-card">
        <h1 className="gate-brand">Almanac<span>.</span></h1>
        <h2>Welcome back.</h2>
        <p>Your passphrase opens your almanac on this device.</p>
