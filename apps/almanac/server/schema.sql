...
CREATE TABLE IF NOT EXISTS vaults (
  ...
  currency    TEXT,                   -- unused by Almanac; kept for a shared server shape
...
-- by Almanac — nothing rides outside the ciphertext). `seq` is a per-user
...
-- Per-user usage (storage quota accounting). media_bytes unused by Almanac
