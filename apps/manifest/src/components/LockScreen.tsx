// LockScreen.tsx
// The vault is closed. Not an item, not a title, not a word of where you're
// going is in memory until the passphrase (or a biometric shortcut to the same
// key) opens it. "Forgot it" hands off to the guardian recovery flow.
  ...
  return (
    <div className="gate">
      <div className="gate-card">
        ...
        <h2>Welcome back.</h2>
        <p>Your passphrase unlocks your lists on this device.</p>
