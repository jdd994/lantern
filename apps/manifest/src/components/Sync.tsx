        ...
        <>
          {guardianCircle ? (
            ...
            <p>
              ...
              passphrase — without us, or any one of them, ever holding the key. For lists you pack
    ...
    <div className="sheet-backdrop" onClick={onClose}>
      <div className="sheet" onClick={(e) => e.stopPropagation()}>
        ...
        {account ? (
          <>
            <p>
              Connected as <strong>{account}</strong>. Your lists sync quietly in the
            ...
            {/* Deleting the account removes the server copy only — the lists on
          ...
          <>
            <p>
              Keep the same lists on your phone and your laptop. This is separate from your
            ...
            <form onSubmit={submit}>
              ...
              {mode === "signin" && !canCreate ? (
                <p className="hint">
                  Signing in downloads your lists to this device. You'll open them with the same
