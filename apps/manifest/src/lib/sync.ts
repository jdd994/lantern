// sync.ts — Manifest's binding to the shared reconcile engine (@lantern/core/sync).
// The engine does the reconcile; this supplies Manifest's kinds, the store
// access, and the network calls. Deliberately NO metaFor: nothing about a list
// rides outside the ciphertext — not a title, not an item, not even which list
// a record belongs to. The server sees "record abc123, 180 bytes, updated at
