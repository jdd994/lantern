...
// file only binds Grove's own verifier token. That token MUST stay "grove-ok"
...
// change-passphrase). MUST stay "grove-ok" forever, or existing vaults break.
export const VERIFIER_TEXT = "grove-ok";
...
export const INVITE_LABELS: InviteLabels = {
  wrapInfo: "grove-invite-wrap",
  proofInfo: "grove-invite-proof",
};

/** Grove's invite keys — the shared HKDF bound to this app's labels. */
