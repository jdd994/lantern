...
//
// So a breach of the sync server yields nothing but noise — not a name, not a
// date, not a word of a letter. This screen is where the user opts in, so it
// says so.
        ...
        <>
          {guardianCircle ? (
            ...
            <p>
              ...
              passphrase — without us, or any one of them, ever holding the key. For a family
              tree, the natural guardians are the family.
            </p>
          )}
...
function GuardianApprovalsSection({
  ...
  return (
    <div className="danger-zone">
      <h4 className="pass-head">Help a family member</h4>
      {done.map((d) => (
    ...
    <div className="sheet-backdrop" onClick={onClose}>
      <div className="sheet" onClick={(e) => e.stopPropagation()}>
        ...
        {account ? (
          <>
            <p>
              Connected as <strong>{account}</strong>. Your tree syncs quietly in the
            ...
            {/* Deleting the account removes the server copy only — the tree on this
          ...
          <>
            <p>
              Keep the same tree on your phone and your laptop. This is separate from your
            ...
            <form onSubmit={submit}>
              ...
              {mode === "signin" && !canCreate ? (
                <p className="hint">
                  Signing in downloads your tree to this device. You'll open it with the same
